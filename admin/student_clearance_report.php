...
<?php 
    ...
    $allSignatory = $report->getAllClearanceSignatory($clearance_id);
?>
    <div class="page">
        ...
        <div>
            <?php foreach($allSignatory as $sig): ?>
                <div class="text-center"> <?php echo strtoupper(str_replace("_", " ", substr($sig['designation_table'], 3, -2))); ?></div>
                <div>
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php 
                                $clearance_report = $report->getSignatoryStudents($sig['designation_table'], $clearance_id);
                                $count = 1;
                                foreach($clearance_report as $studClearance):
                            ?>
                            <tr>
