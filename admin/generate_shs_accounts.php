...
<?php 
    ...
    $allCourse = $user->getAllSHS();
?>
    <div class="page">
        <div class="d-flex justify-content-between align-items-center">
            <div class="fs-4">SHS Student Accounts</div>
        ...
        foreach($allCourse as $course){ 
            $shsCourse = $course['strand'];

            echo '<div class="fs-6">Course: '. $shsCourse . '</div> ';
            for($i = 11; $i <= 12; $i++ ){
                
                $studentAcc = $user->getStudentAccounts($i, $shsCourse);
                if(!empty($studentAcc)){ 
        ?>
