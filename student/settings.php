        ...
        <div class="account-setting p-3 py-0">
            <div class="row shadow-m py-3 px-2 rounded" style="background-color: #fff;">
                <div class="col">
                    ...
                    <div class="form-group mb-2">
                        <label class="form-label mb-0 f-d"><?php echo ($user_data['academic_level'] == 'SHS') ? 'Strand and Year' : 'Course and Year'; ?></label>
                        <input type="text" class="form-control form-control-sm py-2 px-3" value="<?php echo $user_data['program_course'] . " - " . $user_data['year_level'];?>" disabled>
                    </div>
